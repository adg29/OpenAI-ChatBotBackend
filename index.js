...
Form(Humanoid/Non-Humanoid), Gender(Male/Female/Non-Binary, etc.),Approximate age range(25-30) ,Height(Tall/Average/Short) , Build(Slim/Athletic/Heavysez, etc.), SkinTone(Light/Fair/Medium/Olive/Dark, etc.), Eyes(Blue/Black/Brown, etc.), Hair Color(Black/Brunette/Blond/Red/White etc.), Hair Length(Short/Medium/Long), Hair Style(Curly/Straight/Wavy, etc.), Facial Features(Mole/Scar/Freckels(Specify location)), Clothing Style(Medieval/Modern/Futuristic, etc.), Details(Armor/Robes/Casual, etc.), Footwear(Boots/Sandals, etc.),Accessory(Jewelry/Weapons, etc.) ,AdditionalFeatures(Tattoo/Wings/Tails/Magic/Aura/None(Describe if any))
